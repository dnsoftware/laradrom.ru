    ...
    */
    ...
    'connections' => [
        ...
        'pgsql_slave' => [
            'driver' => 'pgsql',
            'url' => env('DATABASE_URL'),
            'host' => env('POSTGRES_HOST_SLAVE', '127.0.0.1'),
            'port' => env('POSTGRES_PORT_SLAVE', '5432'),
            'database' => env('POSTGRES_DB_SLAVE', 'forge'),
            'username' => env('POSTGRES_USER_SLAVE', 'forge'),
            'password' => env('POSTGRES_PASSWORD_SLAVE', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'schema' => 'public',
